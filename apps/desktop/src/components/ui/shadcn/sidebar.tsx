...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  ...
  return (
    <main
      ...
      className={cn(
        "relative flex w-full flex-1 flex-col border border-border/60 bg-background md:peer-data-[variant=inset]:mt-4 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-tl-lg md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        !open && "m-0! rounded-tl-none!",
        className,
      )}
      {...props}
    />
