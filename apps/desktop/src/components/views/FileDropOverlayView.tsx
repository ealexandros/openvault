...
export const FileDropOverlayView = ({ isVisible }: FileDropOverlayViewProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex h-full animate-in items-center justify-center bg-foreground/40 duration-200 fade-in">
      <div className="flex animate-in flex-col items-center gap-4 rounded-xl bg-background px-12 py-14 text-center duration-200 zoom-in-95 slide-in-from-bottom-2">
